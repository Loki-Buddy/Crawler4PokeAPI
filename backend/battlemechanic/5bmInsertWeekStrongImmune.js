    ...
    try {
        ...
        for (let i = 0; i < allPokemon.results.length; i++) {
            ...
            try {
                ...
                const result = await client.query(`SELECT id FROM typ WHERE api_name = $1;`, [this_pokemon.types[0].type.name]);
                await client.query(`INSERT INTO pokemon_weak_strong (typ_id, weak, strong) VALUES ($1, $2, $3)`, [result.rows[0].id, weak, strong]);
